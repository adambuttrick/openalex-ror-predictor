...
def calculate_match(row):
    if row['predicted_ror_id'] and row['ror_id'] in row['predicted_ror_id']:
        return 'Y'
    elif row['predicted_ror_id'] and row['ror_id'] not in row['predicted_ror_id']:
        return 'N'
    elif not row['predicted_ror_id'] and row['ror_id'] == '':
        return 'TN'
    else:
        return 'NP'
